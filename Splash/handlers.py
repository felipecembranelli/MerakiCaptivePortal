...
class RootHandler(BaseRequestHandler):
  def get(self):
    ...
    logging.info('base_grant_url=' + str(self.request.get('base_grant_url')))
    logging.info('base_grant_url=' + str(self.request.get('node_mac')))
...
class ProfileHandler(BaseRequestHandler):
  def get(self):
    ...
    logging.info('ProfileHandler')

    if self.logged_in:

      logging.info('ProfileHandler - islogged')
      #store info on datastore
      #self.SaveToDataStore(self.current_user.name)
      ...
      logging.info('ProfileHandler - is NOT logged')
      self.redirect('/')

  def SaveToDataStore(self, userName):
